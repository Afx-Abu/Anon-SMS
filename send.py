...
def banner():
    ...
    logo = """                                                  
     ...
     \033[0m██            \033[92m▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒            \033[0m██
     \033[0m██     \033[94mCoded by: https://github.com/Afx-Abu                     \033[0m██
     \033[0m██     \033[94mYoutube : https://www.youtube.com/c/AK_MODZ           \033[0m██
     \033[0m██   \033[94mInstagram : https://instagram.com/jsl_.xr     \033[0m██
     \033[0m██                                                                ██
     \033[0m████████████████████████████████████████████████████████████████████
     \033[92m▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒
                                         """
...
def update():
    ...
    for fl in stuff_to_update:
        dat = urllib.request.urlopen("https://raw.githubusercontent.com/Afx-Abu/Anon-SMS/master/" + fl).read()
        file = open(fl, 'wb')
        file.write(dat)
        file.close()
    print('\n\t\tUpdated Successfull !!!!')
...
ver = urllib.request.urlopen("https://raw.githubusercontent.com/Afx-Abu/Anon-SMS/master/.version").read().decode('utf-8')
verl = ''
try:
...
print('\n\tStarting Anon-SMS...\n')
try:
    noti = urllib.request.urlopen("https://raw.githubusercontent.com/Afx-Abu/Anon-SMS/master/.notify").read().decode('utf-8')
    if len(noti) > 10:
        print('\nNotification : ' + noti + '\n')
except Exception:
    pass
